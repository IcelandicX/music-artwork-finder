...
music_fix_install_cli_links() {
    ...
    ln -sf "$project_dir/music_analyze.py" "$bin_dir/music-analyze"
    ...
    ln -sf "$project_dir/music_duplicates.py" "$bin_dir/music-duplicates"
